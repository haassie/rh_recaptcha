# -*- coding: utf-8 -*-
#
# rh_RECAPTCHA documentation build configuration file, created by
# TYPO3 extension sphinx on Fri, 21 Aug 2015 09:01:22 +0200.
#
...
htmlhelp_basename = 'rh_RECAPTCHAdoc'
...
latex_documents = [
    ('Index', 'rh_RECAPTCHA.tex', u'rh_RECAPTCHA',
     u'', 'manual'),
]
...
pdf_documents = [
    ('Index', 'rh_RECAPTCHA', u'rh_RECAPTCHA',
     u''),
]
...
texinfo_documents = [
    ('Index', 'rh_RECAPTCHA', u'rh_RECAPTCHA',
     u'', 'rh_RECAPTCHA', 'One line description of project.',
     'Miscellaneous'),
]
...
# Additional options from Settings.yml
copyright = u'2015'
project = u'rh_RECAPTCHA'
version = u'0'
release = u'0.0.3'
